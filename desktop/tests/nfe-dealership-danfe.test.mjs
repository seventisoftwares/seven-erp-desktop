...
<nfeProc xmlns="http://www.portalfiscal.inf.br/nfe" versao="4.00">
  <NFe><infNFe Id="NFe${key}" versao="4.00">
    ...
    <det nItem="1"><prod><cProd>CAR001</cProd><xProd>VOLKSWAGEN NIVUS HIGHLINE 200 TSI</xProd><NCM>87032310</NCM><CFOP>5102</CFOP><uCom>UN</uCom><qCom>1.0000</qCom><vUnCom>145000.0000</vUnCom><vProd>145000.00</vProd></prod><imposto><ICMS><ICMS40><orig>0</orig><CST>40</CST></ICMS40></ICMS></imposto></det>
    ...
    <infAdic><infCpl>OBSERVACAO COMERCIAL\n\n=== DADOS DOS VEÍCULOS ===\nVEÍCULO 1 — VOLKSWAGEN NIVUS HIGHLINE 200 TSI\nCHASSI/VIN: 9BWZZZ377VT004251  •  RENAVAM: 12345678901  •  PLACA: ABC1D23/RS\nVERSÃO: HIGHLINE 200 TSI  •  ANO FAB/MOD: 2025/2026  •  COR: PRETO\nCÂMBIO: AUTOMATICO  •  COMBUSTÍVEL: FLEX\nOPCIONAIS: TETO SOLAR, BANCOS EM COURO</infCpl></infAdic>
  </infNFe></NFe>
...
test("DANFE automotivo coloca dados do veiculo abaixo do item e usa logo do CNPJ", () => {
  ...
  globalThis.__sevenCompanyLogoResolver = (taxId) => taxId === "12345678000190" ? logo : "";
  const html = buildDanfeHtml({ nfeProcXml: xml });
  assert.match(html, /vehicle-item-details/);
  ...
  delete globalThis.__sevenCompanyLogoResolver;
});
