...
import { buildDanfeHtml, code128Svg, encodeCode128, parseNfeProc } from "../src/nfe-danfe.mjs";
...
<nfeProc xmlns="http://www.portalfiscal.inf.br/nfe" versao="4.00">
  <NFe><infNFe Id="NFe${ACCESS_KEY}" versao="4.00">
    <ide><cUF>43</cUF><natOp>VENDA DE MERCADORIA</natOp><mod>55</mod><serie>1</serie><nNF>123</nNF><dhEmi>2026-09-01T10:00:00-03:00</dhEmi><tpAmb>2</tpAmb></ide>
...
test("DANFE HTML marks homologation and cancelled documents explicitly", () => {
  const homologation = buildDanfeHtml({ nfeProcXml: NFE_PROC });
  assert.match(homologation, /SEM VALOR FISCAL · HOMOLOGAÇÃO/);
  assert.match(homologation, /DANFE/);
  assert.match(homologation, /143260000000001/);
  assert.match(homologation, /CLIENTE TESTE &amp; CIA/);
